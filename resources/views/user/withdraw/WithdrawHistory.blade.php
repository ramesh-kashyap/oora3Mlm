        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <form method="GET" action="{{ route('user.Withdraw-History') }}" class="d-flex align-items-center gap-2 flex-wrap">
                            <!-- Search Input -->
                            ...
                            <!-- Reset Button -->
                            <a href="{{ route('user.Withdraw-History') }}" class="btn btn-secondary btn-sm"
