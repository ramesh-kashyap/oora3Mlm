                        ...
                        <div class="col-12 col-xl-9">
                            <div class="db-page__right globalAccount globalAccountTransactions">
                                <div class="db-page__title-block">
                                    <h2 class="db-page__title">Transactions</h2>
                                </div>
                                        ...
                                        <div class="transactions-empty-wrapper">
                                            <div class="transactions-empty">
                                                ...
                                                <div class="transactions-empty__descr">
                                                    Fund your wallet to use Optima products
                                                </div>
                                                <div class="transactions-empty__button-block">
                                                    <button type="button" class="green-gradient-btn iconed-btn transactions-empty__button button--small optimaDepositButton">
                                                        ...
                                                        <div class="iconed-btn__text">Deposit
                                                        </div>
                                                    </button>
                                                </div>
                                            </div>
                                                                            ...
                                                                            <div class="field-block">
                                                                                <div class="field field--select field--select--small">
                                                                                    <div class="dropdown bootstrap-select select-currency">
                                                                                        ...
                                                                                        <input type="text" class="" placeholder="Search " style="width: 100%" >
                                                                            ...
                                                                            <div class="field-block">
                                                                                <div class="field field--select field--select--small">
                                                                                    <div class="dropdown bootstrap-select select">
                                                                                        <select name="type" class="select" data-none-selected-text="Type" tabindex="null">
                                                                                            ...
                                                                                            <option data-content="&lt;div class=&quot;select-item&quot;&gt;&lt;div class=&quot;select-item-text&quot;&gt;Deposit&lt;/div&gt;&lt;/div&gt;" value="deposit">Deposit</option>
                                                                                            <option data-content="&lt;div class=&quot;select-item&quot;&gt;&lt;div class=&quot;select-item-text&quot;&gt;Staking contract&lt;/div&gt;&lt;/div&gt;" value="withdrawal">Withdrawal</option>
                                                                                            <option data-content="&lt;div class=&quot;select-item&quot;&gt;&lt;div class=&quot;select-item-text&quot;&gt;Affiliate reward&lt;/div&gt;&lt;/div&gt;" value="partner">Staking reward</option>
                                                                                            <option data-content="&lt;div class=&quot;select-item&quot;&gt;&lt;div class=&quot;select-item-text&quot;&gt;Career bonus&lt;/div&gt;&lt;/div&gt;" value="career_bonus">Direct Reward</option>
                                                                                            <option data-content="&lt;div class=&quot;select-item&quot;&gt;&lt;div class=&quot;select-item-text&quot;&gt;Bonus&lt;/div&gt;&lt;/div&gt;" value="bonus">Staking Referral Reward</option>
                                                                                            <option data-content="&lt;div class=&quot;select-item&quot;&gt;&lt;div class=&quot;select-item-text&quot;&gt;Cashback by upline&lt;/div&gt;&lt;/div&gt;" value="refback_up">Team Development Reward</option>
                                                                                            <option data-content="&lt;div class=&quot;select-item&quot;&gt;&lt;div class=&quot;select-item-text&quot;&gt;Cashback for partners&lt;/div&gt;&lt;/div&gt;" value="refback_down">Club Reward</option>
                                                                                        </select>
...
<div class="db-transaction-table-item db-transaction-table-item--deposit">
            ...
            <div class="db-transaction-t-i-type db-transaction-t-i-type--deposit">
                ...
                <div class="db-transaction-t-i-type__right">
                    <div class="db-transaction-t-i-type__title">
                        {{ ucfirst($row->type ?? 'Deposit') }}
                    </div>

                    <div class="db-transaction-t-i-type__descr">
                        {{ strtoupper($row->network ?? 'BEP20') }}
                    </div>
                </div>
    ...
    <div class="db-transaction-t-i-cell db-transaction-t-i-cell--amount">
        ...
        <div class="db-transaction-t-i-cell__content">
            ...
            <div class="db-transaction-t-i-amount 
                ...
                {{ number_format($row->amount, 2) }} {{ strtoupper($row->currency ?? 'USDT') }}
            </div>
    ...
    <div class="db-transaction-t-i-cell db-transaction-t-i-cell--date">
        ...
        <div class="db-transaction-t-i-cell__content">
            ...
            {{ \Carbon\Carbon::parse($row->created_at)->format('h:i A, M d Y') }}

        </div>
    </div>

    <!-- DETAILS -->
    <div class="db-transaction-t-i-cell db-transaction-t-i-cell--detail">
        <div class="db-transaction-t-i-cell__title">Details</div>
        <div class="db-transaction-t-i-cell__content">

            <button class="db-transaction-view-button"
                data-bs-toggle="modal"
                data-bs-target="#modalTransaction-{{ $row->id }}">
            </button>
