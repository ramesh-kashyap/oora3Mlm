            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                      ...
                      <div class="card-header">
                        <form method="GET" action="{{ route('user.DepositHistory') }}" class="d-flex align-items-center gap-2 flex-wrap">
                            <!-- Search Input -->
                            ...
                            <!-- Reset Button -->
                            <a href="{{ route('user.DepositHistory') }}" class="btn btn-secondary btn-sm"
