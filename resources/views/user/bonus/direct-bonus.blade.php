<div class="content-body" style="min-height: 732px;">
            ...
            <div class="col-md-12">
                <div class="card custom--card h-100">
                     <div class="card-header">
                      ...
                      <div class="card-header">
                        <form method="GET" action="{{ route('user.referral-bonus') }}" class="d-flex align-items-center gap-2 flex-wrap">
                            <!-- Search Input -->
                            ...
                            <!-- Reset Button -->
                            <a href="{{ route('user.referral-bonus') }}" class="btn btn-secondary btn-sm"
 ...
 {{ $level_income->appends(request()->query())->links() }}
                </div>
