            ...
            <div class="col-md-12">
                <div class="card custom--card h-100">
                     <div class="card-header">
                        <h4 class="card-title">Same Rank Profit sharing Bonus</h4>
                    </div>
                    <div class="card-header">
                        <form method="GET" action="{{ route('user.samerankprofit-bonus') }}" class="d-flex align-items-center gap-2 flex-wrap">
                            <!-- Search Input -->
                            ...
                            <!-- Reset Button -->
                            <a href="{{ route('user.samerankprofit-bonus') }}" class="btn btn-secondary btn-sm"
