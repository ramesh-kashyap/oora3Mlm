       ...
       <div class="container-fluid">
           <div class="row page-titles">
               <ol class="breadcrumb">
                   ...
                   <li class="breadcrumb-item"><a href="javascript:void(0)">Power Activation</a></li>
               </ol>
           </div>
           <!-- row -->
           <div class="row">
               ...
               <div class="col-xl-6 col-lg-12">
                   <div class="card">
                       <div class="card-header">
                           <h4 class="card-title">Power Activation</h4>
                       </div>
                       <div class="card-body">
                           <div class="basic-form">
                               <form action="{{ route('admin.power_post') }}" method="POST">
                                {{ csrf_field() }}
                                   <div class="row">
                                       <div class="mb-3 col-md-12">
                                           <label class="form-label">Enter Amount</label>
                                        
                                                    <input placeholder="Enter Amount"  class="form-control" type="number"  name="amount" value="" >
                                       </div>
