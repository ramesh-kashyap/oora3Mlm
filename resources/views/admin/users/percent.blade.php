       ...
       <div class="container-fluid">
           <div class="row page-titles">
               <ol class="breadcrumb">
                   ...
                   <li class="breadcrumb-item"><a href="javascript:void(0)">3 % Activation</a></li>
               </ol>
           </div>
           <!-- row -->
           <div class="row">
               ...
               <div class="col-xl-6 col-lg-12">
                   <div class="card">
                       <div class="card-header">
                           <h4 class="card-title">3%/6% Activation </h4>
                       </div>
                       <div class="card-body">
                           <div class="basic-form">
                               <form action="{{ route('admin.activatepercentage') }}" method="POST">
                                {{ csrf_field() }}
                                   <div class="row">
           ...
           <!--                                 <input type="text" placeholder="Verification Code" class="form-control" name="code">-->
											<!--<button class="btn btn-primary first-code-send" type="button">Send</button>-->
           <!--                             </div>-->
            <label class="form-label">Note</label>
             <div class="input-group mb-3">
                 
                                           <textarea id="topupAmount" rows="4" class="form-control form--control" name="remarks" placeholder="write your remarks" ></textarea>
                                        </div>
