            ...
            <div class="container-fluid">
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Pending Kyc</a></li>
					</ol>
                </div>
                <!-- row -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                          <form action="{{ route('admin.pending-kyc') }}" method="GET">
                                        <div class="row">
                                            <div class="col-xl-4">
                                            ...
                                            <div class="col-xl-2">
                                                <div class="form-group mb-3">
                                                    <a href="{{ route('admin.pending-kyc') }}" style="padding: 0.6rem 2rem;"
                                                        name="reset"
                                                        class="btn btn-outline-theme btn-lg d-block w-100 btn-primary"
                                                        value="Reset">Reset</a>
                                                </div>
                                                   ...
                                                   <td>
                                                    ...
                                                    @if($row->kyc_status === 'Pending')
                                                        <div class="d-inline-flex gap-2">
                                                            <a href="{{ route('admin.kyc.status', ['user' => $row->user_id, 'kyc_status' => 'Approved']) }}"
                                                               class="btn btn-success btn-sm"
                                                               onclick="return confirm('Approve this KYC?');">
                                                               Approve
                                                            </a>
                                                
                                                            <a href="{{ route('admin.kyc.status', ['user' => $row->id, 'kyc_status' => 'Rejected']) }}"
