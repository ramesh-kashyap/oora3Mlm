...
class Dashboard extends Controller
{
    ...
    public function add_content()
    {
        ...
        $content = DB::table('add_content')->orderBy('id', 'desc')->first();

        $this->data['content'] = $content;

        $this->data['page'] = 'admin.setting.add-content';
        return $this->admin_dashboard();
    }
    ...
    //             'content1.required' => 'Content1 is required',
    //             'content2.required' => 'Content2 is required',
    //         ];
...
public function add_content_post(Request $request)
{
    try {
        ...
        $msg = [
            'title.required'    => 'Title is required',
            'content1.required' => 'Content 1 is required',
            'content2.required' => 'Content 2 is required',
        ];
        ...
        // Agar record exist karta hai to update karo, warna insert
        $content = DB::table('add_content')->first();
        if ($content) {
            DB::table('add_content')->where('id', $content->id)->update([
                'title'     => $data['title'],
                'content1'  => $data['content1'],
                'content2'  => $data['content2'],
                'updated_at'=> now(),
